...
```{r}
edges <- read_csv("https://raw.githubusercontent.com/krisrs1128/stat436_s24/main/data/covid-edges.csv")
nodes <- read_csv("https://raw.githubusercontent.com/krisrs1128/stat436_s24/main/data/covid-nodes.csv")
```
